    ...
    return (
        <>
            <div className="w-full relative z-[0]">
                ...
                <div className="text-[40px]  leading-[40px] tracking-[-1.14px] mt-[20px] text-center lg:mt-[50px] lg:text-[88px] lg:text-start lg:leading-[88px] font-[700] lg:tracking-[-1.5px]">
                    <p>Nice to meet you!</p>
                    <p>I'm <span className="decoration-[#4EE1A0] underline underline-offset-[0.6rem]">Joe Märtens</span>.</p>
                </div>

                <p className="mx-auto lg:mx-0 flex text-center mt-[40px] text-[16px] leading-[26px] w-[343px] lg:mt-[43px] lg:w-[445px] font-[500] lg:text-[18px] tracking-[0px] lg:text-start lg:leading-[28px] lg:m-">Full stack developer from Montevideo with a strong passion for elegant web apps and a keen eye to catch the attention of the most perfectionist.</p>

                {/* Desktop */}
                <a href="#contact"><p className="hidden lg:flex w-[95.7px] hover-underline-animation uppercase mt-[56px] lg:hover:text-[#4EE1A0] transition duration-300 hover:ease-in">contact me</p></a>
                {/* Mobile */}
