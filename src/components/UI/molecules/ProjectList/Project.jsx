...
const Project = ({ name, technologies, src, deploy, git }) => {
    ...
    return (
        <div className="mt-[40px] lg:mt-0 flex flex-col w-full h-[398px] lg:w-[540px] lg:h-[487px] relative" onMouseEnter={handleVisibility} onMouseLeave={handleVisibility}>
            {isVisible && <div className="hidden lg:flex justify-between absolute z-[3] right-[307px] top-[167px] bg-[#242424] w-[400px] rotate-90 uppercase text-[20px] p-[20px] leading-[26px] tracking-[2.29px] font-[700]">
                <a href={deploy}><p className="hover-underline-animation hover:text-[#4EE1A0] transition duration-300 hover:ease-in">view project</p></a>
