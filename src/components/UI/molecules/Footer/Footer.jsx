...
const Footer = ({ name, socials }) => {
    return (
        <footer className="bg-gradient-to-t from-white to-[#4EE1A0] pt-[39px] lg:pt-[47px] pb-[60px] lg:pb-[92px] flex flex-col items-center lg:flex-row w-full justify-between z-[2]  absolute left-0 px-[165px]">
