...
const ResponseRecorded = () => {
    return (
        <div className="items-center justify-center flex flex-col lg:flex-row pt-[-60px] lg:pt-[84px] lg:justify-between border-b-[1px] border-white lg:pb-[70px] lg:[px-0] min-h-[521px]">
            <div className="w-1/2">
