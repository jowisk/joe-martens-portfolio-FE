...
const Contact = () => {
    ...
    return (
        <div className="flex flex-col lg:flex-row pt-[60px] lg:pt-[84px] justify-between border-b-[1px] border-white pb-[70px] lg:[px-0]">
            <div>
            ...
            <form onSubmit={submitHandler} method="post" className="mt-[50px] mb-[20px] lg:mb-0 lg:mt-0 flex flex-col lg:w-[637px] lg:h-[366px] tracking-[-0.22px] items-end">
                ...
                <button disabled={!isValidEmail} className="leading-[26px] tracking-[2.29px] font-[700] mt-[32px] hover-underline-animation" type="submit">SEND MESSAGE</button>
            </form>
        </div >
    )
}
